...
class DiscadorController{     
    ...
    */
    ...
    async tabularChamada(req,res){
        ...
        const r = await _Discador2.default.tabulaChamada(idAtendimento,contatado,status_tabulacao,observacao,produtivo,ramal)
        res.json(r); 
    }
    ...
    async desligarChamada(req,res){
        ...
        const tabulacoesCampanha = await _Discador2.default.tabulacoesCampanha(dadosChamadaDesligada[0].id_campanha)
        if(tabulacoesCampanha==false){
