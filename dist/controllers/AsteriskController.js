...
class AsteriskController{
    ...
    async agi(req,res){
        ...
        if(action=='handcall'){//Quando ligacao eh manual, preview ou click-to-call
            ...
            const r = await _Discador2.default.registraChamada(empresa,ramal,idCampanha,modoAtendimento,tipoDiscador,idMailing,tabela_dados,tabela_numeros,id_reg,id_numero,numero,fila,tratado,atendido)
            await _Discador2.default.alterarEstadoAgente(empresa,ramal,6,0)
            await _Discador2.default.registraHistoricoAtendimento(empresa,protocolo,idCampanha,idMailing,id_reg,id_numero,ramal,uniqueid,tipoDiscador,numero,tabulacao,observacoes,contatado)
        ...
        if(action=='answer'){//Quando ligacao eh atendida pelo agente
            ...
            if(tipoChamada=="manual"){
                ...
                await _Discador2.default.alterarEstadoAgente(empresa,ramal,7,0)
