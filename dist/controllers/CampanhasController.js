...
class CampanhasController{
    ...
    criarCampanha(req,res){
        ...
        _Campanhas2.default.criarCampanha(tipo,nome,descricao,(e,result)=>{ 
            ...
            const autopause = "no"
            const maxlen = "0"
            _Asterisk2.default.criarFila(name,musiconhold,strategy,timeout,retry,autopause,maxlen,(e,r)=>{
                if(e) throw e;
    ...
    statusEvolucaoCampanha(req,res){
        ...
        _Campanhas2.default.mailingsNaoTrabalhados_porCampanha(idCampanha,(e,nao_Trabalhados)=>{
            if(e) throw e
