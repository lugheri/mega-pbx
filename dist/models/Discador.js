...
class Discador{
    ...
    filtrarRegistro(idCampanha,tabela,idMailing,tentativas,ordem,callback){
        ...
        _dbConnection2.default.mailings.query(sql,(er,reg)=>{
            if(er) throw er
            ...
            if(reg.length > 0){
                ...
                _dbConnection2.default.mailings.query(sql,(er,verificacao)=>{
    ...
    ligar(ramal,numero,callback){
        ...
        _dbConnection2.default.banco.query(sql,(e,asterisk_server)=>{
            ...
            _Asterisk2.default.ligar(server,user,pass,modo,ramal,numero,(e,call)=>{
                if(e) throw e
