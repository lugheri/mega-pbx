...
module.exports = (routes) => {
    ...
    routes.delete('/removerFila/:nomeFila',CampanhasController.removerFila)//removerFila
    //MembrosFilas    
    routes.get('/getMembersFila/:idFila',FilasController.getMembersFila)//getMembers
