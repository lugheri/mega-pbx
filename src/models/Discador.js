...
class Discador{
    ...
    filtrarRegistro(idCampanha,tabela,idMailing,tentativas,ordem){
        return new Promise((resolve,reject)=>{
            ...
            connect.mailings.query(sql,(e,rows)=>{
                if(e)
                    return reject(e)
                ...
                if(rows.length > 0){
                    ...
                    connect.mailings.query(sql,(e,verificacao)=>{
        ...
        return new Promise((resolve,reject)=>{
            ...
            connect.banco.query(sql,(e,numeroCompleto)=>{
                ...
                if(numeroCompleto != 0){
                    ...
                    connect.mailings.query(sql,(e,numero)=>{
                        if(e) 
                            reject(e)
            ...
            if(estadoAnterior==2){
                ...
                connect.banco.query(sql,(e,r)=>{
                    ...
                    connect.banco.query(sql,(e,r)=>{
                        if(e) 
                            reject(e)
                        Cronometro.saiuDaPausa(agente,(e,r)=>{
                            if(e) 
                                reject(e)
                        })
                    })
                ...
                connect.banco.query(sql,(e,r)=>{
                    if(e) 
                        ...
                        if(estado==1){
                           ...
                           connect.banco.query(sql,(e,infoPausa)=>{
                                if(e) 
                                    reject(e)
